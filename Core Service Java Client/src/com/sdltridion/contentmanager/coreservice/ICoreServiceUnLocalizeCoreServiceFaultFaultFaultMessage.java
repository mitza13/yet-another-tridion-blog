...
public class ICoreServiceUnLocalizeCoreServiceFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param faultInfo
     */
    public ICoreServiceUnLocalizeCoreServiceFaultFaultFaultMessage(String message, CoreServiceFault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public ICoreServiceUnLocalizeCoreServiceFaultFaultFaultMessage(String message, CoreServiceFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
