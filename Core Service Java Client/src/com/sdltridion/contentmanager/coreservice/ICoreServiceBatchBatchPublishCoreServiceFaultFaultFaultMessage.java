...
public class ICoreServiceBatchBatchPublishCoreServiceFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param faultInfo
     */
    public ICoreServiceBatchBatchPublishCoreServiceFaultFaultFaultMessage(String message, CoreServiceFault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public ICoreServiceBatchBatchPublishCoreServiceFaultFaultFaultMessage(String message, CoreServiceFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
