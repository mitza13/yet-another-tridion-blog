...
public class ICoreServiceCheckOutCoreServiceFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param faultInfo
     */
    public ICoreServiceCheckOutCoreServiceFaultFaultFaultMessage(String message, CoreServiceFault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public ICoreServiceCheckOutCoreServiceFaultFaultFaultMessage(String message, CoreServiceFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
