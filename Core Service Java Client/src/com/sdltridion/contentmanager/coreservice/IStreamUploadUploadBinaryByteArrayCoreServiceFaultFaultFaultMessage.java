...
public class IStreamUploadUploadBinaryByteArrayCoreServiceFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param faultInfo
     */
    public IStreamUploadUploadBinaryByteArrayCoreServiceFaultFaultFaultMessage(String message, CoreServiceFault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public IStreamUploadUploadBinaryByteArrayCoreServiceFaultFaultFaultMessage(String message, CoreServiceFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
