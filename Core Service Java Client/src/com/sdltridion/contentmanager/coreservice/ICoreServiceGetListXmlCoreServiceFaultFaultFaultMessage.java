...
public class ICoreServiceGetListXmlCoreServiceFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param faultInfo
     */
    public ICoreServiceGetListXmlCoreServiceFaultFaultFaultMessage(String message, CoreServiceFault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public ICoreServiceGetListXmlCoreServiceFaultFaultFaultMessage(String message, CoreServiceFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
